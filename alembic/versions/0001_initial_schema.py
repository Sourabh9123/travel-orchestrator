...
def upgrade() -> None:
    trip_status = postgresql.ENUM("DRAFT", "PLANNING", "VALIDATING", "READY", "BOOKING", "BOOKED", "FAILED", name="tripstatus")
    booking_status = postgresql.ENUM("PENDING", "CONFIRMED", "CANCELLED", "FAILED", name="bookingstatus")
